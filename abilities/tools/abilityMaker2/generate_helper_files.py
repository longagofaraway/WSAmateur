...
public slots:
    void autoAbilityChangedProxy(const asn::Ability& value, QString componentId) {
        autoAbilityChanged(std::get<asn::AutoAbility>(value.ability), componentId);
    }
    void eventAbilityChangedProxy(const asn::Ability& value, QString componentId) {
        eventAbilityChanged(std::get<asn::EventAbility>(value.ability), componentId);
    }
'''
