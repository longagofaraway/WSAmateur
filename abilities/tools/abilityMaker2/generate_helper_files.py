...
class Language:
    ...
    def getQmlSetterCode(self):
        return f'''void ComponentMediator::{self._qmlSetterDeclaration()} {{
...
'''
    ...
    def getSlotFunctionDefinition(self, type):
        ...
        return f'''void ComponentMediator::{self._slotFunctionDeclaration(type)} {{
...
'''
    ...
    def getSlotFunctionDeclaraion(self, type):
        return f'''void {self._slotFunctionDeclaration(type)};
'''
...
for filename in sys.argv[1:]:
    ...
    hpp += lang.getQmlSetterDeclaraion()

    qml_setter_code += lang.getQmlSetterCodeFooter()
    cpp += qml_setter_code
    for key in slot_code:
        hpp += lang.getSlotFunctionDeclaraion(key)
